...
KEYWORDS = ['acrylic', 'wooden', 'wood', 'plate', 'stand', 'sign']

def get_product_urls(limit=20):
    product_urls = set()
    page = 1
...
def main():
    ...
    with open('nameplate_potential.json', 'w') as f:
        json.dump(products, f, indent=4)
    print(f"Done. Saved {len(products)} potential name plate products.")
